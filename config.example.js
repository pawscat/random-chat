...
module.exports = {
  MAIN_BOT_TOKEN: 'ISI_TOKEN_BOT_UTAMA_DISINI',
  REPORT_BOT_TOKEN: 'ISI_TOKEN_BOT_REPORT_DISINI',

  // Konfigurasi Database Turso & Vercel
  TURSO_DATABASE_URL: 'ISI_TURSO_URL_DISINI',
  TURSO_AUTH_TOKEN: 'ISI_TURSO_TOKEN_DISINI',
